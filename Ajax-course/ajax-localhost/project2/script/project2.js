    ...
    xhr.onreadystatechange = function () {
        ...
        if ( xhr.readyState === 4 && xhr.status === 200 ) {
            ...
            if ( temperatureOutput >= 83 ) {
                ...
                spanHot.id = 'hotTemperatureImg';
                h3Temperature.appendChild(spanHot);
                ...
                var spanCold = document.createElement('span');
                spanCold.id = 'coldTemperatureImg';
                h3Temperature.appendChild(spanCold);
            ...
            if ( windSpeed > 15 ) {
                ...
                temperatureContainer.appendChild(divImageBox);
